    ...
    return (
      ...
      <div className="max-w-screen-lg mx-auto my-auto"> 
          ...
          <div className="absolute -inset-1 -m-4 ring bg-dark-silver bg-opacity-10 ring-dark-silver rounded-lg blur"></div>
              ...
              <button type="submit" id="search-btn" onClick={() => navigate('stats', { state: { searchedPlayer: searchText } })} className="absolute end-2.5 bottom-2.5 font-medium rounded-lg text-sm px-4 py-2"> 
